...
namespace WeLearn.Data.Migrations
{
    ...
    [Migration("20220821204729_Add_DocumentVersion_Fix_Notification")]
    partial class Add_DocumentVersion_Fix_Notification
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WeLearn.Data.Models.Content.Content", b =>
                {
                    ...
                    b.Property<DateTime?>("ExternalCreatedDate")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("WeLearn.Data.Models.CourseCredentials", b =>
                {
                    b.Property<Guid>("CourseId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("CourseId", "CredentialsId");

                    b.HasIndex("CredentialsId");

                    b.ToTable("CourseCredentials");
                });
            ...
            modelBuilder.Entity("WeLearn.Data.Models.FollowedStudyYear", b =>
                {
                    ...
                    b.ToTable("FollowedStudyYears");
                });

            modelBuilder.Entity("WeLearn.Data.Models.Identity.DbPersistedGrant", b =>
                {
            ...
            modelBuilder.Entity("WeLearn.Data.Models.CourseCredentials", b =>
                {
                    b.HasOne("WeLearn.Data.Models.Course", "Course")
                        .WithMany("CourseCredentials")
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WeLearn.Data.Models.Credentials", "Credentials")
                        .WithMany("CourseCredentials")
            ...
            modelBuilder.Entity("WeLearn.Data.Models.Credentials", b =>
                {
                    b.HasOne("WeLearn.Data.Models.Course", null)
            ...
            modelBuilder.Entity("WeLearn.Data.Models.Course", b =>
                {
                    ...
                    b.Navigation("CourseCredentials");
